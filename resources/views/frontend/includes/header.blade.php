    ...
    <div class="itoffcanvas">
        ...
        <div class="itoffcanvas__info">
            ...
            <div class="it-info-wrapper mb-20 d-flex align-items-center">
                ...
                <div class="itoffcanvas__info-address">
                    <span>Location</span>
                    <a href="" target="_blank">1170 Utsav Vihar Kanjhawala road Rohini Sector 39 Delhi 110081</a>
                </div>
            </div>
        </div>
    </div>
...
<header class="it-header-height z-index-2">

    <div id="header-sticky" class="it-header-wrap p-relative">

        <!-- header-top-area-start -->
        <div class="it-header-top-area it-header-top-ptb black-bg">
            <div class="container container-1650">
                <div class="row align-items-center">
                    <div class="col-xxl-7 col-xl-8 col-lg-7 col-md-6 col-sm-6">
                        <div class="it-header-top-list-box">
                        </div>
                    </div>
                    <div class="col-xxl-5 col-xl-4 col-lg-5 col-md-6 col-sm-6 d-none d-sm-block">
                        <div class="d-flex justify-content-end align-items-center">
                            <div class="it-header-top-social-box text-end">
                                ...
                                <a
                                    href="https://www.instagram.com/bharat.steelfabricator?utm_source=qr&igsh=bzZqbTl3cnFnMWw1
https://www.facebook.com/people/Bharat-Steel-Fabricator/61588490130025/">
        ...
        <!-- header-area-start -->
        <div class="it-header-area it-header-style-4 white-bg it-header-ptb">
            <div class="container container-1650">
                <div class="p-relative">
                    <div class="row align-items-center">
                        <div class="col-xxl-2 col-xl-2 col-lg-6 col-md-6 col-6">
                            <div class="it-header-logo-red">
                                <a href="{{ route('home') }}"><img class="logo-style"
                                        src="{{ asset('assets/img/custom/logo.jpeg') }}" alt=""></a>
                            </div>
                        </div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="has-dropdown">
                                            ...
                                            <ul class="it-submenu submenu">
                                                <li><a href="{{ route('aluminium-profile-gate') }}">Aluminium Profile
                                                        Gate</a>
                                                </li>
                                                <li><a href="{{ route('glass-railing') }}">Glass Railing</a></li>
                                                <li><a href="{{ route('steel-gate') }}">Steel Gate</a></li>
                                                <li><a href="{{ route('powder-coated-railing') }}">Powder Coated
                                                        Railing</a></li>
                                                <li><a href="{{ route('duplex-staircase') }}">Duplex Staircase</a></li>
                                                <li><a href="{{ route('iron-steel-interior-work') }}">Iron and Steel
                                                        Interior
                                                        Work</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-6">
                            <div class="it-header-right-action d-flex justify-content-end align-items-center">
                                <a href="{{ route('contact') }}" class="it-btn-orange d-none d-md-flex">
                                    <span>
                                ...
                                <div class="it-header-top-list ml-40 d-none d-xxl-flex align-items-center">
                                    <div class="it-header-top-list-icon">
                                        <span>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="it-header-top-list-text">
                                        <span>Call us any time</span>
                                        <a class="border-line-black" href="tel:8750287795">(+91) 8750287795</a>
                                    </div>
                                </div>
                            </div>
                        </div>
