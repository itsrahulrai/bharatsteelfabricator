 <title>Add Pages -  Frontline Logistics</title>
<x-app-layout>
    <div class="py-0">
                    ...
                    <div class="card rounded mt-3 border" style="border-color:#000;">
                        ...
                        <div class="card-body">
                               ...
                               <!-- Name -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if(isset($page) && $page->image)
                                        <div class="mt-2">
                                            <img src="{{ asset($page->image) }}" alt="{{ $page->alt }}" width="120" class="img-thumbnail">
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="text-end mt-4">
                                <button type="submit" class="btn" style="background-color:#0C6161;; color:#fff;">
